    ...
    <VStack mt={8} alignItems="flex-start" spacing={3} px={4}>
      ...
      >
        ...
        <chakra.div
            ...
            alignItems="center"
          >
            <CircularProgress value={review.concept} min={0} max={10} mx={5} color="cyan.400" size="30px" thickness="14px">
              <CircularProgressLabel color={'gray.500'} fontWeight="semibold" fontSize="xs">{review.concept}</CircularProgressLabel>
            </CircularProgress>
            <CircularProgress value={review.cinema} min={0} max={10} mx={5} color="yellow.500" size="30px" thickness="14px">
              <CircularProgressLabel color={'gray.500'} fontWeight="semibold" fontSize="xs">{review.cinema}</CircularProgressLabel>
            </CircularProgress>
            <CircularProgress value={review.perform} min={0} max={10} mx={5} color="red.400" size="30px" thickness="14px">
